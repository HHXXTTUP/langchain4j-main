...
public class WatchlistEntity {
    ...
    // Keep a database default so upgrading an existing watchlist table can backfill old rows.
    @Column(name = "source_category", nullable = false, length = 32,
            columnDefinition = "varchar(32) not null default 'MANUAL'")
    private String sourceCategory = "MANUAL";
