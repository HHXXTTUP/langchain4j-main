...
10. **复刻段落两块正文协议**：每个可单独交给视频模型的 `segments[].text` 必须严格只有两个自然段，来自当前集不同且有因果推进的剧情。不要为了凑固定段数切碎同一场戏：同一时间、同一空间、同一机位和同一组连续动作尽量合并为一个段落，按不超过30秒的容量写足；只有发生明确的场景、时间、机位或空间关系变化时才拆开，短段可以保留。通常输出6至10段，但以镜头边界和剧情因果为准。
     第一自然段只建立一次本段镜头：直接写环境和空间锚点，再写主体构图、景别、视角、焦段感和摄影机运镜，控制在1至2句；不要写人物资料、剧情动作或对白。第二自然段必须紧接第一段开始的动作，禁止再次写地点、环境氛围、构图、景别、焦段、镜头或运镜，不得用同义改写重复第一段环境；按当前集真实剧情顺序写足同一镜头内的连续动作，至少展开5个有先后关系的可见动作或反应（接近、试探、受阻、改变策略、产生结果），把实际出场人物真实姓名、外貌、当集服装装束、动作因果、受力、表情生理变化、视线落点、光线如何作用于人物和道具、清晰度、景深、中文双引号对白和现场声音融入正文，并写出动作结果。同一镜头下第二自然段建议260至420个汉字，对白量必须控制在30秒可说完，不能用空泛形容词凑字数。发生新场景或新机位时，第一段重新建立新镜头，第二段只写该镜头剧情，不回写旧镜头。
